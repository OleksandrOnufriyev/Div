...
$sql = "SELECT * FROM motorcycles WHERE id = 13"; 
...
<div id="description-page">
    <div class="product-info">
        <h1>Ventus Active VS110QT-1</h1>
		<div class="product-image">
            <img src="https://content2.rozetka.com.ua/goods/images/big/8430564.jpg" alt="Фото мотоцикла">
        </div>
