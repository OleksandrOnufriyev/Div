...
$sql = "SELECT * FROM motorcycles WHERE id = 14"; 
...
<div id="description-page">
    <div class="product-info">
        <h1>Shineray XY250GY-6C Light</h1>
		<div class="product-image">
            <img src="https://content2.rozetka.com.ua/goods/images/big/355108000.jpg" alt="Фото мотоцикла">
        </div>
