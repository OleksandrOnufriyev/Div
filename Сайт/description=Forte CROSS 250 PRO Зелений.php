...
$sql = "SELECT * FROM motorcycles WHERE id = 9"; 
...
<div id="description-page">
    <div class="product-info">
        <h1>Forte CROSS 250 PRO Зелений</h1>
		<div class="product-image">
            <img src="https://content2.rozetka.com.ua/goods/images/big/353621467.jpg" alt="Фото мотоцикла">
        </div>
