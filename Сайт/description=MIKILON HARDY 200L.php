...
$sql = "SELECT * FROM motorcycles WHERE id = 12"; 
...
<div id="description-page">
    <div class="product-info">
        <h1>MIKILON HARDY 200L</h1>
		<div class="product-image">
            <img src="https://content.rozetka.com.ua/goods/images/big/409673123.jpg" alt="Фото мотоцикла">
        </div>
        <div class="product-description">
            <h1>Опис квадроцикла</h1>
