 ...
 <header>
    ...
    <div id="description-page">
        <div class="product-info">
            <h1>GEON DAKAR GNS 300 (4V)</h1>
            <div class="product-description">
                <p>Мотоцикл Geon Dakar GNS 300:
...
Максимальна швидкість, км / год: 120
        ...
        <div class="product-image">
            <img src="https://mototek.com.ua/previev.php?src=https://mototek.com.ua/components/com_jshopping/files/img_products/full_GEON_DAKAR_GNS_300__4V___1_.jpg&w=531&h=403" alt="Фото мотоцикла">
        </div>
    </div>
</body>
</html>
